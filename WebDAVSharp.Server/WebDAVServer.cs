...
namespace WebDAVSharp.Server
{
    ...
    public class WebDAVServer : WebDAVDisposableBase
    {
        ...
        public WebDAVServer(IWebDAVStore store, ILogger logger = null, IHttpListener listener = null, IEnumerable<IWebDAVMethodHandler> methodHandlers = null)
        {
            ...
            var en = methodHandlers.GetEnumerator();
            bool b = en.MoveNext();
            ...
            */
            ...
            _MethodHandlers = new Dictionary<string, IWebDAVMethodHandler>();

            foreach (var methodHandler in methodHandlers)
            {
                foreach (var name in methodHandler.Names)
                {
                    _MethodHandlers.Add(name, methodHandler);
                }
            }
